        ...
        <footer className="relative bottom-0 w-[100vw] bg-[--dit-dark-blue]">
            <div className="flex justify-between items-center px-6 py-4 lg:px-8">
                ...
                <div className="flex gap-4">
                    <a href="https://www.facebook.com/deltaglobalbr" className="text-gray-500 hover:text-gray-400">
                    ...
                    <a href="https://www.instagram.com/deltaglobalbr/" className="text-gray-500 hover:text-gray-400">
                    ...
                    <a href="https://www.youtube.com/channel/UCpvShE7gXJth_lBJNT3IL9A" className="text-gray-500 hover:text-gray-400">
